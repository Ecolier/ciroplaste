...
function StoryHeader({ title, text, backgroundImageURL }: StoryHeaderProps) {
  return (
    <div className="sticky top-[calc(-50vh+64px)] flex h-[50vh] w-full flex-col items-center justify-center md:-top-[16.665vh] md:h-[33.333vh]">
      <div className="sticky flex flex-col items-center justify-center md:top-0 md:h-[16.665vh]">
        <h1 className="text-chalk-50 font-serif text-5xl text-[4.9998vh] mb-[1.6665vh]">{title}</h1>
