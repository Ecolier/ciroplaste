...
function Marquee({ children }: PropsWithChildren) {
  return (
    <div className="-z-10 absolute flex bg-orange-100 dark:bg-orange-800 select-none cursor-default top-0 font-serif font-black h-full text-9xl text-black dark:text-white dark:text-opacity-5 text-opacity-5">
