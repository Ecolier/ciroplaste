        ...
        {headings.map((heading, index) => {
          return (
            <div key={index} className="flex items-center flex-shrink-0">
              <span
                className={`dark:text-zinc-200 cursor-pointer text-zinc-900 ${headings[index + 1] ? `` : `font-semibold`} max-w-36 inline-block overflow-ellipsis whitespace-nowrap overflow-hidden`}
